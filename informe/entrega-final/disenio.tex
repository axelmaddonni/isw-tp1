...
\par Si el usuario efectivamente es un Mod y llena las formas de manera válida, se genera el bar y su perfil, que se agregan al conjunto de bares mediante el mensaje \texttt{agregarBares}.
