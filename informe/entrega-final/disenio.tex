...
\par Si el usuario efectivamente es un Mod y llena las formas de manera válida, se genera el bar y se le pasa el mensaje \texttt{agregarBares} al conjuntoDePerfiles, que construye el perfil del bar y lo incorpora al conjunto de perfiles existentes.
